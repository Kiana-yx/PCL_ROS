...
void img_cb(const sensor_msgs::Image::ConstPtr &image)
{
	...
	stringstream ss;
	ss << "/home/kiana/catkin_ws//data/images/" << count_img << ".jpg" << endl;
...
void velo_cb(const sensor_msgs::PointCloud2::ConstPtr &in_cloud)
{
	...
	stringstream ss;
	ss << "/home/kiana/catkin_ws/data/pointcloud/" << count_pcd << ".pcd";
...
int main(int argc, char **argv)
{
	...
	sub_img = nh.subscribe("/camera/image", 1, img_cb);
	...
	while (ros::ok())
	{
		...
		std::cout << " 's' to save an input sample" << std::endl;
